...
This file has been modified to support spsc_value a triple buffer implementation of a single element queue
in the dv-ros2 project. We can get rid of this file once we upgrade to a newer boost version.
...
private:
    ...
    static const bool allow_multiple_reads = false;
